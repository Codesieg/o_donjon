...
final class Version20210504135834 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE caracteristic (id INT AUTO_INCREMENT NOT NULL, level INT DEFAULT NULL, experience INT DEFAULT NULL, inspiration TINYINT(1) DEFAULT NULL, armor_class INT DEFAULT NULL, speed INT DEFAULT NULL, current_hp INT DEFAULT NULL, total_hp INT DEFAULT NULL, hit_dice LONGTEXT DEFAULT NULL, death_saves_success INT DEFAULT 0, death_saves_failures INT DEFAULT 0, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
